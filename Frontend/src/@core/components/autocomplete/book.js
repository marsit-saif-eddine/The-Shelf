...
const [suggestionChange , setSuggestionChange] = useState('')
  ...
  useEffect(() => {
    ...
    if (suggestionChange != props.suggestion ){
      setSuggestionChange(props.suggestion)
      setUserInput(props.suggestion)
   
    }
}, [focused, props.defaultSuggestions ,userInput, props.suggestion])
...
console.log(e.target.value)
      ...
      />
      {props.invalid && <FormFeedback>Please enter a book name</FormFeedback>}
      {suggestionsListComponent}
    </div>
  )
}
