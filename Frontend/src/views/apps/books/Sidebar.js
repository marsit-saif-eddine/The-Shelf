                ...
                {ratings.map(item => {
                  return (
                    <div key={item.total} className='ratings-list'>
                      <a href='/Users/Ibtihel/Desktop/themeforest-ilFb38KZ-vuexy-vuejs-html-laravel-admin-dashboard-template/vuexy-admin-v8.2.2/react-version/Bootstrap5/full-version/full-version/src/views/pages' onClick={e => e.preventDefault()}>
