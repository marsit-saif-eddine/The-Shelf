...
import {rateUser} from '../../apps/user/store'
...
const ProfileAbout = ({ selectedUser }) => {
  // ** State
              ...
              <ul className='list-unstyled'>
                ...
                <li className='mb-75'>
                  ...
                  <span>
                    ...
                    }} value={selectedUser.rate} max={5}

                      onChange={(event, value) => {  console.log(selectedUser.rate);store.dispatch(rateUser({ profileId: selectedUser._id, value })) }}
