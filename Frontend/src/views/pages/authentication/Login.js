...
const Login = () => {
        ...
        .then((res) => {
          ...
          toast((t) => (
            <ToastContent
              ...
              name={data.firstname || data.lastname || "John Doe"}
            />
          ));
        })
        .catch((err) => {
          console.log(err);
          toast((t) => <Toast message={err.response.data.message} />);
        });
    } else {
  ...
  const handleGoogleLogin = (informationUser) => {
    ...
    toast((t) => (
      <ToastContent
        t={t}
        role={informationUser.role || "admin"}
        name={
          informationUser.firstname || informationUser.lastname || "John Doe"
        }
      />
    ));
  };
